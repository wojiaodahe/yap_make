...
struct i_socket
{
	int 				 	 prot_type;                   /* inet ×åÐ­ÒéÀàÐÍ tcp or udp or raw or ... */
	void 				  	*prot;                       /* inet ×åÐ­Òé¿ØÖÆ¿é tcp_pcb udp_pcb raw_pcb ... */
	struct i_proto_opt 	  	*i_prot_opt;  				  /* inet ×åÃ¿ÖÖÐ­ÒéµÄ²Ù×÷½Ó¿Ú */
